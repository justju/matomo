...
describe("RowEvolution", function () {
    ...
    it('should load when icon clicked in ViewDataTable', async function() {
        ...
        await row.hover();
        const icon = await page.$('a.actionRowEvolution:visible');
        await icon.hover();
        await page.click('a.actionRowEvolution:visible');
    ...
    it('should load multi-row evolution correctly', async function() {
        ...
        await page.mouseMove('tbody tr:nth-child(2)');
        await page.mouseMove('a.actionRowEvolution:visible');
        await page.click('a.actionRowEvolution:visible');
        await page.waitForNetworkIdle();
